...
?>
			...
			<li><b><?php
_erw( 'upgrade_analytics' );
?>
</b></li>
			<li><b><?php
_erw( 'upgrade_white-labeled' );
?>
</b></li>
			<li><b><?php
_erw( 'upgrade_bbpress-forum-topics' );
?>
</b></li>
			<li><b><?php
_erw( 'upgrade_ip-identification' );
?>
</b></li>
			<li><b><?php
_erw( 'upgrade_custom-design' );
?>
</b></li>
			<li><b><?php
_erw( 'upgrade_unlimited-criteria' );
?>
</b></li>
			<li><?php
_erw( 'upgrade_reputation-rating' );
?>
</li>
			<li><?php
