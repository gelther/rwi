...
>
					<span><?php
_erw( 'comment-ratings-mode_standard' );
?>
</span>
				</div>
				<div
					class="rw-ui-img-radio rw-ui-img-radio-review-mode rw-ui-hor<?php
if ( 'true' === $comment_ratings_mode ) {
    echo  ' rw-selected' ;
}
?>
">
					<i class="rw-ui-sprite"></i> <input type="radio" name="rw_comment_review_mode"
					                                    value="true" <?php
checked( 'true', $comment_ratings_mode );
?>
>
					<span><?php
_erw( 'comment-ratings-mode_reviews' );
?>
</span>
				</div>
				<div
					class="rw-ui-img-radio rw-ui-img-radio-review-mode rw-ui-hor<?php
if ( 'admin_ratings' === $comment_ratings_mode ) {
    echo  ' rw-selected' ;
}
?>
">
					<i class="rw-ui-sprite"></i> <input type="radio" name="rw_comment_review_mode"
					                                    value="admin_ratings" <?php
checked( 'admin_ratings', $comment_ratings_mode );
?>
>
					<span><?php
_erw( 'comment-ratings-mode_author' );
?>
</span>
				</div>
			</div>
